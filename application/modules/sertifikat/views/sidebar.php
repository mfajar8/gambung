<div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active nav-item"><a href="<?= base_url()?>sertifikat"><i class="feather icon-home"></i><span class="menu-title" data-i18n="">sertifikat</span></a>
                </li>
                <li class="active nav-item"><a href="<?= base_url()?>user"><i class="feather icon-home"></i><span class="menu-title" data-i18n="">user</span></a>
                </li>
